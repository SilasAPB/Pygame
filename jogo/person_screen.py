...
def person_screen(window):
    ...
    while running<3:
        ...
        window.blit(assets[PLAYER2_IMG_L], (5*WIDTH/8,(HEIGHT/8)+30))
        ...
        window.blit(assets[PLAYER3_IMG_L], (5*WIDTH/8,(5*HEIGHT/8)+10))
        window.blit(textop1_d,((5*WIDTH/8)-50,(5*HEIGHT/8)-70))
        window.blit(textop2_right,(((5*WIDTH/8)-50,(5*HEIGHT/8)-40)))

        window.blit(assets[PLAYER4_IMG_L], (WIDTH/8,(5*HEIGHT/8)+10))
